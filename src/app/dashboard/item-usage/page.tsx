...
export default function ItemUsagePage() {
  ...
  const itemUsageData = React.useMemo(() => {
  ...
  }, [date, patientType, paymentMethod, transactions, inventory]);

  const handleExportData = () => {
    const dataToExport = itemUsageData.map(item => ({
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Item Usage Report');
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Monitor items sold based on the selected filters.
        </p>
      </div>
